...
const allureResults = `results/allure-results`;
const allureReports = `allure-report`;
const overrideResults = true;
exports.config = {
    //
    // ====================
     ...
     */
     onPrepare: () => {
        ...
        if (overrideResults) {
            removeSync(allureResults);
            if (!fs.existsSync(allureResults)){
                fs.mkdirSync(allureResults);
            }

            removeSync(allureReports);
            if (!fs.existsSync(allureReports)){
                fs.mkdirSync(allureReports);
            }
        }
    },    
     ...
     */
     onComplete: function() {
        ...
        const generation = allureCmd(['generate', allureResults, 'open', '--clean'])
